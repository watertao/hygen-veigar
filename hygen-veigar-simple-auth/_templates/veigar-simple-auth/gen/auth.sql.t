...
--
-- Host: 47.95.248.33    Database: demacia
-- ------------------------------------------------------
...
--
-- Table structure for table `t_auth_audit_log`
--

DROP TABLE IF EXISTS `t_auth_audit_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_auth_audit_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '标识符',
  `resource_verb` varchar(16) NOT NULL COMMENT '资源动词',
  `resource_uri_pattern` varchar(256) NOT NULL COMMENT '资源URI模式',
  `resource_name` varchar(128) NOT NULL COMMENT '资源名称',
  `operator_id` int(11) NOT NULL COMMENT '操作人ID',
  `operator_login_name` varchar(128) NOT NULL COMMENT '操作人登录名',
  `operator_name` varchar(128) NOT NULL COMMENT '操作人姓名',
  `operator_type` varchar(1) NOT NULL COMMENT '操作人类型。1: normal; 2: supervisor',
  `request_entity` text COMMENT '请求体',
  `response_entity` text COMMENT '响应体',
  `operate_time` datetime NOT NULL COMMENT '请求时间',
  `cost` int(11) NOT NULL COMMENT '请求耗时（ms）',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2019-04-29 16:08:07
